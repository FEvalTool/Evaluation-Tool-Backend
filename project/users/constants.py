...
class EventType:
    ...
    GENERATE_SECURITY_QA_VERIFICATION_TOKEN = "GENERATE_SECURITY_QA_VERIFICATION_TOKEN"
    GENERATE_PASSWORD_VERIFICATION_TOKEN = "GENERATE_PASSWORD_VERIFICATION_TOKEN"
